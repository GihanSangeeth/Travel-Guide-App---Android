...
public class DB_Sqlite_Favorite extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table favorite ( id INTEGER PRIMARY KEY AUTOINCREMENT, Title TEXT,page_id INTEGER,Description Text, Img TEXT)");
    }
    ...
    public Boolean Insert_to_favorite(String Title, int page_id, String Description, int Img) {
    ...
    public ArrayList get_All_Favorite() {
        ...
        while (!rs.isAfterLast()) {
            ...
            int Img= rs.getInt(rs.getColumnIndex("Img"));
            arraylist.add(new List_itme_Index(id,Title,page_id,Description,Img));
            rs.moveToNext();
        }
        return arraylist;
    }
    ...
    public Integer Delete(String id) {
        SQLiteDatabase db = this.getWritableDatabase();
        return db.delete("favorite", "page_id = ?", new String[]{id});
    }
